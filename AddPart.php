    ...
    <div class="mobile-container">
      ...
      <br>
       <div style="padding:10px, 10px">
        <form name="frmPart" method="post" action="scripts/Process_AddPart.php" enctype="multipart/form-data">
        <fieldset>
          <legend><big>Add Part:</big></legend>
          <label for="txtAddPart">Part name/description:</label>
          <input type="text" id="txtAddPart" name="txtAddPart" required>
          <textarea id="txtAddVerse" name="txtAddVerse" rows="4" cols="50" required></textarea>
