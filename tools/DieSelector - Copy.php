    ...
    <div style="padding:10px, 10px">
      ...
      <form name="frmDieSelection" method="get" action="DieSelector.php" >
        <fieldset>
          ...
          <label for="mtlThickness">Material Thickness in Decimal:</label>
          <input type="number" id="mtlThickness" name="mtlThickness" min="0" max="1" step="0.00001" required>
          <br><br>
        </fieldset>
      ...
      <div>
        ...
        <div id="parent">
            ...
            <?php
              ...
              $dblMaterialThickness = $_GET["mtlThickness"];
